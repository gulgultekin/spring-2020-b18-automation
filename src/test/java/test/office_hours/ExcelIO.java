...
public class ExcelIO {
    ...
    public void readExcelFile(){
        ...
        try(FileInputStream fileInputStream = new FileInputStream("VytrackTestUsers.xlsx")){
            // .xlsx
            //XSSFWorkbook - to create object of .xlsx file
            //HSSFWorkbook - to create an of .xls file
            //Workbook -is an interface, that is implemented by XSSFWorkbook and HSSFWorkbook

            Workbook workbook = WorkbookFactory.create(fileInputStream);
            //Objecet of Sheet used to represent excel file page
            //because , 1 excel document can have many spreadsheet
            Sheet sheet = workbook.getSheet("QA1-short");
            //read a first row
            Row row = sheet.getRow(0);
            //object of Cell class reprresent some cell. Row consists of cells
            //read a first cell
            Cell cell = row.getCell(0);
            //read a value from 1st row  1 column
